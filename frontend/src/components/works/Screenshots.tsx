    ...
    return (
        <section>
            <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-neutral-100 tracking-tight">スクリーンショット</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-1 lg:row-span-2">
                    <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-gray-200 dark:border-neutral-700 shadow-md mb-4 bg-gray-50 dark:bg-neutral-800">
                        <Image
                    ...
                    {screenshots[activeIndex].caption && (
                        <div className="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm text-gray-800 dark:text-neutral-200 p-3 rounded-lg border border-gray-100 dark:border-neutral-700 shadow-sm mb-6">
                        ...
                        {screenshots.map((screenshot, index) => (
                            <button
                                ...
                                className={`relative aspect-video rounded-lg overflow-hidden border transition-all duration-200 ${activeIndex === index
                                    ? 'border-black dark:border-white shadow-md scale-105 z-10'
                            ...
                            >
                                ...
                                />
                                <div className={`absolute inset-0 bg-black/10 dark:bg-white/10 backdrop-blur-[1px] transition-opacity duration-200 ${activeIndex === index ? 'opacity-0' : 'opacity-100'
                                    }`}></div>
                            </button>
                        ))}
                    </div>
