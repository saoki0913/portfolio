...
export const Contact = () => {
    ...
    return (
        <section ref={sectionRef} id="contact" className="mt-24 md:mt-32 py-16 md:py-24 px-4 md:px-6 bg-white dark:bg-neutral-900 relative overflow-hidden transition-colors duration-300">
            {/* 背景装飾 */}
