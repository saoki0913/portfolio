            ...
            <div className="container mx-auto">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                    {skillCategories.map((category, categoryIndex) => (
                        <motion.div
                            key={category.title}
                            className="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-md border border-neutral-100 dark:border-neutral-700 relative overflow-hidden group cursor-default transition-all duration-300 hover:shadow-[0_10px_30px_rgba(59,130,246,0.12)] hover:border-blue-300/50 dark:hover:shadow-[0_16px_48px_rgba(168,85,247,0.25)] dark:hover:border-purple-500/50"
